...
export function HomeNews({ posts }: Props) {
  return (
    <section
      id="news"
      className="section-space border-b border-border bg-surface/70"
    >
      <div className="container-page">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-muted">
              Лента обновлений о встречах и жизни клуба.
            </p>
          </div>
          <Link
            href="/news"
        ...
        {posts.length === 0 ? (
          <div className="mt-8 rounded-[var(--radius-card)] border border-border bg-background px-5 py-8 text-center">
            <p className="text-foreground">Пока нет опубликованных новостей</p>
            <p className="mt-2 text-sm text-muted">
              Как только появятся публикации, они отобразятся в этой ленте.
            </p>
          </div>
        ) : (
